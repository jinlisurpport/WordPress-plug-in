...
/**
 * Plugin Name: WooCommerce jlpay-支付宝(不挂机)
 * Plugin URI: https://jlpay.jinlisoft.kr/
 * Description: jlpay提供的支付宝(不挂机)支付
 * Version: 1.0.0
 * Author: jlpay.jinlisoft.kr
 * Author URI: https://jlpay.jinlisoft.kr/
 */
...
function init_woocommerce_gateway_paysapi_alipay_nophone()
{
    ...
    class Paysapi_WC_Payment_Gateway_Alipay_NoPhone extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->method_title = 'jlpay-支付宝(不挂机)';
        ...
        public function init_form_fields()
        {
            $this->form_fields = array(
                'app_key' => array(
                    ...
                    'type' => 'text',
                    'default' => '',
                    'description' => 'Uid可到jlpay商戶後台(https://jlpay.jinlisoft.kr/mypage/userinfo)的「接口信息」中查看',
                    'desc_tip' => true,
                ),
                'app_secret' => array(
                    'title' => 'Token',
                    'type' => 'text',
                    'default' => '',
                    'description' => 'Token可到jlpay商戶後台(https://jlpay.jinlisoft.kr/mypage/userinfo)的「接口信息」中查看',
                    'desc_tip' => true,
                )
            );
        }
